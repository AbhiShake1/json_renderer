...
plugins can be passed during `JsonRenderer.init`, that are available through packages (future plan). also, new plugins can be created and added based on future requirements. lets see an example implementation of a custom plugin:
